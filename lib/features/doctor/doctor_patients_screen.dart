  ...
  Future<void> _fetchPatients() async {
    try {
      ...
      for (var c in citas) {
        ...
        final aptDateAtMidnight = DateTime(aptDate.year, aptDate.month, aptDate.day);
      ...
      for (var p in patientsList) {
        ...
        if (pastApts.isNotEmpty) {
          ...
          futureApts.sort((a, b) => a.compareTo(b)); // Más cercana en el futuro primero
          p['lastVisit'] = 'Próxima';
      ...
      patientsList.sort((a, b) => (b['sortDate'] as DateTime).compareTo(a['sortDate'] as DateTime));
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0, 
        title: const Text('Mis Pacientes', style: TextStyle(fontWeight: FontWeight.w700)), 
        leading: IconButton(
                      ...
                      itemBuilder: (_, i) {
                        ...
                        return Padding(
                          ...
                          child: GestureDetector(
                            onTap: () => context.go('/doctor/medical-record?patient=${Uri.encodeComponent(p['name']?.toString() ?? 'Paciente')}'),
                            child: Container(
                              ...
                              child: Row(
                                children: [
                                  Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                    Text(p['name']?.toString() ?? 'Paciente', style: const TextStyle(fontSize: 16, fontWeight: FontWeight.w800, color: AltheaColors.navy)),
